...
def create_appointment():
    ...
    try:
                ...
                "appointments": [
                    {
                        ...
                        "client_note": appt.client.note if appt.client else None,
        ...
        response_data = {
            ...
            "client_note": new_appt.client.note if new_appt.client else None,
    ...
    for appt in appointments:
        ...
        if session_id not in grouped:
            ...
            if not client and cellulare_norm:
                ...
                phone_matches = client_cache[phone_key] or []
                phone_match_count = len(phone_matches)
                phone_only_match = phone_matches[0] if phone_matches else None
            ...
            if client:
                ...
                grouped[session_id]["match_phone_count"] = phone_match_count
            else:
                # Nessun match
...
def api_info_operator_detail(operator_id):
    ...
    # Esclude i BLOCCHI OFF da TUTTE le statistiche dell'operatore. Un blocco OFF è
    # un appuntamento assegnato al cliente segnaposto "dummy" (nome E cognome ==
    # "dummy"), come da definizione is_off altrove in questo file: non è lavoro reale
    # e non deve contare in totale/ultimi 30gg/media/incasso/ultimo appuntamento.
    _not_off_block = ~and_(
        func.lower(func.coalesce(Client.cliente_nome, '')) == 'dummy',
        func.lower(func.coalesce(Client.cliente_cognome, '')) == 'dummy',
    )
    ...
    # (stessa esclusione dei blocchi OFF).
    rows_6mo = (
        db.session.query(
            Appointment.service_id,
